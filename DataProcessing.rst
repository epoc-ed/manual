...
``dxtbx.install_format -u FormatHDFJungfrau1MJFJVIE02_multipanel.py``
    Installation of the specific class file
    `FormatHDFJungfrau1MJFJVIE02_multipanel.py <https://github.com/epoc-ed/GUI/blob/developer/jungfrau_gui/metadata_uploader/FormatHDFJungfrau1MJFJVIE02_multipanel.py>`_
    to read the HDF file with DIALS. This should be done if the HDF format is updated.
